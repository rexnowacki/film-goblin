...
- **User admin.** Find / view / suspend / delete accounts, inspect
  watchlists + alert history. Read-and-delete primitives first; audit
  log later.
...
- **Onboarding resumability.** If a user bails halfway through the
  5-chapter ritual, pick up where they left off on next login.
