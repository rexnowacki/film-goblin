...
const PLAN: Record<string, TagPlan> = {
  ...
  "6b8b1d93-e45e-43a6-8c7a-7bb1eb9bdb79": {
    ...
    themes: ["paranoia", "queer", "class"],
    settings: ["small town"],
    order: ["slasher", "paranoia", "mean-spirited", "queer", "funny", "claustrophobic", "class", "small town", "horror comedy"],
  },
  ...
  "27cf8869-4033-414b-aed1-17295bc68572": {
    ...
    themes: ["race", "class", "obsession"],
    settings: ["urban horror"],
    content: ["gore"],
    order: ["supernatural horror", "race", "atmospheric", "obsession", "bleak", "ghosts", "cursed place", "class", "urban horror", "gore", "slasher"],
  },
  ...
  "b7ad7369-07d6-41f5-8237-a51fbe439639": {
    ...
    settings: ["urban horror"],
    content: ["violent"],
    order: ["home invasion", "claustrophobic", "mean-spirited", "class", "urban horror", "violent", "thriller"],
  },
  "1998daef-35e6-4593-94ca-96784f75bd21": {
    ...
    themes: ["class"],
    content: ["gore"],
    order: ["supernatural horror", "demons", "funny", "campy", "cursed object", "class", "gore", "horror comedy"],
  },
  ...
  "d67901d8-9883-415d-9868-3f7f3d50d0fd": {
    ...
    settings: ["wilderness"],
    content: ["gore", "violent"],
    order: ["survival horror", "claustrophobic", "mean-spirited", "bleak", "class", "wilderness", "gore", "violent", "thriller"],
  },
  ...
  "bfbb8c0c-5a0b-4f4e-aa7c-f03030ce4eb4": {
    ...
    themes: ["class", "sexuality"],
    content: ["sexual content"],
    order: ["cursed media", "cursed object", "surreal", "class", "psychedelic", "dreamlike", "sexuality", "sexual content"],
  },
